...
ALTER TABLE network ADD CONSTRAINT fk_validator FOREIGN KEY (id) REFERENCES validator(id) ON DELETE NO ACTION;
...
ALTER TABLE network ADD CONSTRAINT fk_secondary_transformer FOREIGN KEY (id) REFERENCES transformer(id) ON DELETE NO ACTION;
...
ALTER TABLE network ADD CONSTRAINT fk_primary_transformer FOREIGN KEY (id) REFERENCES transformer(id) ON DELETE NO ACTION;
